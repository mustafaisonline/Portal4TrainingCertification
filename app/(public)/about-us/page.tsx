...
/*
 * PORTED 2026-09-21 from project-artifacts/mockup/app/about-us/page.tsx (ADR-045)
 * Changed: founder read from `listPublishedExperts()` (first published expert)
 * instead of the mockup's data/practitioners.ts, guarded for an empty list;
 * the mockup's own <PublicShell> wrapper dropped (app/(public)/layout.tsx
 * provides it); metadata title shortened. Copy unchanged.
 */
...
export default async function AboutPage() {
  ...
  return (
    <>
      ...
      {/* ===== Who is behind it =====
          2026-09-07, founder direction: filled with an AI-generated teaching
          scene ("Turning real-world experience into practical skills"),
          public/delivery/about-founder-teaching.png. This is a generic
          AI-generated figure, not the founder's actual photograph — that
          distinction matters because this section's own copy is about the
          founder as a named individual. `illustration` stays in place, inert
