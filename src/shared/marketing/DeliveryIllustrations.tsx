/*
 * PORTED 2026-09-21 from project-artifacts/mockup/components/illustrations/DeliveryIllustrations.tsx
 * (ADR-045). Unchanged apart from this header and `as const` on three
 * coordinate-pair arrays (required by `noUncheckedIndexedAccess`) — original,
 * deterministic inline SVG illustrations for the `ImageFrame` stand-in
 * state; no data involved.
 */
