...
| [`MILESTONE_7_EXECUTION_PLAN.md`](MILESTONE_7_EXECUTION_PLAN.md) | **Renewal reminders** — 30/7-day and lapsed reminders to the outbox, idempotent through audit rows, authenticated jobs endpoint for whatever scheduler hosting provides, holder notifications, admin "last run"; no schema change | ▶ **EXECUTING 2026-09-23** (overnight instruction) |
| [`MILESTONE_8_EXECUTION_PLAN.md`](MILESTONE_8_EXECUTION_PLAN.md) | **Trainer / admin operations** — admin navigation, orders & payments (read-only), enquiries, users & roles, audit log, reports with CSV, participant data export; §5 lists organisations, invoices, attendance, refund-on-behalf, account deletion **for founder approval (schema / policy)** | ▶ **EXECUTING 2026-09-23** (existing-schema scope) · ⛔ §5 awaiting approval |
| [`MILESTONE_9_EXECUTION_PLAN.md`](MILESTONE_9_EXECUTION_PLAN.md) | **Production readiness** — health endpoint, security headers, fail-fast config, error pages, robots/sitemap, backup & restore scripts, Dockerfile, runbooks, restart-resilience test; §4 lists hosting, DB host, residency, domain, email provider, release gate **for the founder** | ▶ **EXECUTING 2026-09-23** (code + runbooks) · ⛔ §4 decisions and provisioning are the founder's |
| [`MILESTONE_10_EXECUTION_PLAN.md`](MILESTONE_10_EXECUTION_PLAN.md) | **Launch cutover** — readiness checklist, claims reconciliation, wireframe-remnant check; the cutover itself (legal publication, live Stripe, domain, mockup archive) is the founder's | ▶ **EXECUTING 2026-09-23** (audit) · ⛔ cutover is the founder's |
