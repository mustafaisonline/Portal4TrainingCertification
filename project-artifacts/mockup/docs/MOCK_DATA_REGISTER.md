...
| Programme **prices** | **Withheld — deliberately** | The source publishes RM/USD figures. Pricing presentation is open (`HO-7`) and payment is deferred (ADR-014/OQ-2), so no figure appears anywhere. Recoverable from the source when the founder decides |
