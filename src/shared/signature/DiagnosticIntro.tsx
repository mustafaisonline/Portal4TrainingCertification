/*
 * PORTED 2026-09-21 from project-artifacts/mockup/components/signature/DiagnosticIntro.tsx
 * (ADR-045). Unchanged apart from this header and the `@/shared/ui` import
 * path — pure presentation, no data.
 */

import { Card } from "@/shared/ui/Card";

/**
 * Shared diagnostic-intro pieces — the homepage embed and the standalone
 * /diagnostic page render the identical thing, so the two can never drift
 * apart on this content. Pure presentation — no state, no logic — safe to
 * render from either entry point.
 */

/** Shared stroke props for this file's local icon glyphs. */
const iconStroke = {
  stroke: "currentColor",
  strokeWidth: 1.7,
 ...
 *  deterministic inline SVG — not a photograph. A single gauge/target
 *  reading in a floating card, with a small "assessed" check-badge
