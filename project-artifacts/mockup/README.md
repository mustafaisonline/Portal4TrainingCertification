...
| `/account/orders/[id]`, `/account/notifications`, `/account/help`, `/admin/*` | Added 2026-09-20. Sample receipt; notification samples; help signposts; **trainer/admin wireframe** (sample tables, disabled actions, no roles) |
