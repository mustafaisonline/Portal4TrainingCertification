...
/*
 * PORTED 2026-09-21 from project-artifacts/mockup/components/legal/PolicyPlaceholder.tsx (ADR-045)
 * Changed: dropped the mockup's own <PublicShell> wrapper (app/(public)/layout.tsx
 * provides it) and repointed UI imports to src/shared/ui. Copy unchanged.
 */
 ...
 * missing"). One component, four routes: /terms, /privacy, /refund-policy,
